...
describe User do
  ...
  it "should require matching passwords" do
  	bad_password_match_user = User.new(@attr.merge(:password_confirmation => "fart"))
  	bad_password_match_user.should_not be_valid
  end
  ...
  describe "password encryption" do
  	...
  	describe "has_password? method" do
		...
		it "should be false if the passwords don't match" do
  			@user.has_password?("fart").should be_false
  		end
	...
	describe "authenticate method" do
		...
		it "should return nil for email address that does not match a user" do
			nonexistent_user = User.authenticate("notin@thedb.com", @attr[:password])
			nonexistent_user.should be_nil
		end
		
		it "should return an authenticated user for a email/password match" do
